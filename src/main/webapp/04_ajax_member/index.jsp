...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function getList() {
			...
			$.ajax({
				...
				$(data).find("member").each(function() {
					...
					tbody += "<td><input type='button' value='삭제' id='del' name='"+ $(this).find("idx").text() +"'></td>";
		...
		// 회원가입
		// form을 이용해서 데이터를 전달할때는 직렬화(serialize())를 해야 된다.
		// form 요소만 가능
